...
const ItemsPagination = () => {
  ...
  // pagination items array, length equal total pages
      ...
      <div className="flex-center">
        ...
        {portionNumber > 1 && (
          <button
            ...
            className="group h-10 flex-center text-pagination-color text-[15px] font-medium hover:bg-pagination-color hover:text-white rounded-[10px] pr-4 pl-2"
          >
        ...
        {totalPages / paginationLength !== portionNumber && (
          <button
            onClick={() => setPortionNumber(portionNumber + 1)}
            className="group h-10 flex-center text-pagination-color text-[15px] font-medium hover:bg-pagination-color hover:text-white rounded-[10px] pr-2 pl-4"
          >
            Next
